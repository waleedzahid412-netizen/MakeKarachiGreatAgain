...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#0a0f1a] p-4 font-sans text-slate-300 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#111827] border border-slate-700/50 rounded-2xl p-8 shadow-2xl transition-all duration-300 hover:border-emerald-500/30 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-3 px-4 rounded-xl shadow-lg shadow-emerald-500/20 active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:pointer-events-none text-sm"
          >
            {loading ? (
        ...
        <div className="mt-8 text-center text-sm text-slate-400 space-y-4">
          ...
          <div className="pt-4 border-t border-slate-800/40">
            <Link
              to="/transparency"
              className="text-emerald-450 hover:text-emerald-350 text-xs font-bold transition-colors"
            >
